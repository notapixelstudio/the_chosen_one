class DragonScript:
	...
	func next_positive_line(feature, value):
		...
		if len(positive_lines[feature][value]) == 0:
			...
			var readable_value = value.replace('-',' ')
			return [
				"XYou are not the sharpest tool in the shed, huh? Your " + readable_value + " " + readable_feature + " won't do.",
				"XThe Chosen One has no " + readable_value + " " + readable_feature + ".",
				"XWrong " + readable_feature + ". Got it? You are doomed.",
				"XDid you ever have the feeling of being controlled by a superior entity? What if that entity were a clueless human like you?",
				"XDo you think before you act? I think you should try sometimes. It is an enlighting experience.",
				"XGuess who is the Chosen One? Not you.",
				"XWhy don't you try a different " + readable_feature + "? Just for fun, I asked for no real reason.",
				"XThere is no mention of a " + readable_value + " " + readable_feature + " like yours in the Prophecy."
			][randi() % 8]
